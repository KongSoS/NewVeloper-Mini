...
public class PL_ManagerMenu {
	...
	/**
	 * @MethodName : placeManagementMenu.java
	 * @Project : NewVeloper_mini
	 * @Date : 2022. 11. 17.
	 * @작성자 : jihee 
	 * @프로그램 설명 : 관리자가 추천장소 리스트를 조회한다.
	 */
	...
	/**
	 * @MethodName : selectOne.java
	 * @Project : NewVeloper_mini
	 * @Date : 2022. 11. 17.
	 * @작성자 : jihee 
	 * @프로그램 설명 : 매장 한 곳에 대한 정보를 출력한다.
	 */
	private void selectOne(ArrayList<PL_ListAllDTO> placeList, int no) {
		...
		switch (choice) {
			case 1:
				...
				break;
			case 2:
				plController.deletePlaceList(placeList.get(no-1).getPl_no());
				break;
			case 0:
				return;
			default :
	 ...
	 * @작성자 : jihee
	 * @변경이력 :
	 * @프로그램 설명 : 관리자가 추천 장소에 대한 정보를 수정한다.
	 */

...
INSERT INTO PL_USER
VALUES (SEQ_USER_NO.NEXTVAL, 'uesr01', 'user01', '김아무개', '01011112222', SYSDATE , NULL , 'N' ,'Y');
...
COMMENT ON COLUMN RESERVATION.USER_ID IS '아이디';
...
ALTER TABLE RESERVATION 
ADD CONSTRAINT FK_USER_ID FOREIGN KEY (USER_ID) REFERENCES PL_USER(USER_ID);

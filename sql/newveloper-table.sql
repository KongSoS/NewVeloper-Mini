...
ADD CONSTRAINT PFK_PL_NO FOREIGN KEY (PL_NO) REFERENCES PLACE_LIST(PL_NO);

ALTER TABLE LIST_TAG 
ADD CONSTRAINT FK_LTAG_CODE FOREIGN KEY (TAG_CODE) REFERENCES TAG(TAG_CODE);
...
ALTER TABLE MY_TAG 
ADD CONSTRAINT PFK_MY_NO FOREIGN KEY (MY_NO) REFERENCES MY_LIST(MY_NO);

ALTER TABLE MY_TAG 
ADD CONSTRAINT FK_MTAG_CODE FOREIGN KEY (TAG_CODE) REFERENCES TAG(TAG_CODE);

ALTER TABLE MY_TAG 
ADD CONSTRAINT UN_MY_NO_CODE UNIQUE (MY_NO, TAG_CODE);

ALTER TABLE MY_TAG 
MODIFY MY_NO CONSTRAINT NN_MTAG_NO NOT NULL;
